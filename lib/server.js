...
const deleteSession = request => {
  console.log('<deleteSession> Entry')
  let browserCookies = request.header.Cookie
  console.log('<deleteSession> browserCookies = ', browserCookies)
  if (browserCookies && sessionHasCookie(browserCookies)) {
    console.log('<deleteSession> Entry If contiion sessionHasCookie(browserCookies) =', sessionHasCookie(browserCookies))
    console.log('<deleteSession> Inside IF SESSION.browserCookies= ', SESSION[browserCookies])
    delete SESSION[browserCookies]
  }
  console.log('<deleteSession> SESSION = ', SESSION)
}
